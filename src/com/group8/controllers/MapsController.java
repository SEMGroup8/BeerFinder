                ...
                if (event.getClickCount() == 2) {
                    ...
                    for (int i = 0; i < markers.size(); i++) {
                        ...
                        if(i == z) {
							...
							selectedPub = new Pub("select pubs.pubID,`name`,image, `phoneNumber`, `description`, `offers`, `entrenceFee`, addressID from pubs where pubID =" + BeerData.markers.get(z).getPubID());
